...
const models: TsoaRoute.Models = {
    ...
    "GetUserListResponseDTO": {
        "dataType": "refAlias",
        "type": {"ref":"PaginatedResponse_UserResponseDTO_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/users',
            function UserController_getList(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/user',
            ...
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"CreateUserRequestDTO"},
            };
